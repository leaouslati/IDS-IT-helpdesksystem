...
namespace backend.Infrastructure.Services
{
    public class EmailService : IEmailService
    {
        ...
        public static string BuildOtpEmailBody(string recipientName, string otp, int expiryMinutes)
        {
            var name = System.Net.WebUtility.HtmlEncode(recipientName);
                        ...
                        <tr>
                          <td style="background:linear-gradient(135deg,#0f172a 0%,#1e293b 100%);padding:28px 32px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td style="padding-top:12px;">
                                  <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;">Password Reset Code</p>
                                  <p style="margin:4px 0 0;font-size:13px;color:#94a3b8;">IDS Internal Support System</p>
                                </td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 24px;font-size:14px;color:#475569;line-height:1.6;">
                              Use the code below to reset your password. This code expires in {expiryMinutes} minutes.
                            </p>
