...
namespace backend.Data
{
    public static class DbSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            // Seed Departments (must happen before users due to FK)
            ...
            // Seed initial users (with department assignments)
            ...
            // Seed additional users (idempotent per-email, with department assignments)
            ...
            // Set Department ManagerIds (IT → manager@, HR → david@)
            ...
            // Update DepartmentId for existing users that don't have one yet
            ...
            // Seed Tickets (with DepartmentId; ~half unassigned with Open status)
            if (!await context.Tickets.AnyAsync())
            {
                ...
                var emp1 = await context.Users.FirstAsync(u => u.Email == "employee@helpdesk.com"); // IT
                var emp2 = await context.Users.FirstAsync(u => u.Email == "alice@helpdesk.com");    // HR
                var emp3 = await context.Users.FirstAsync(u => u.Email == "bob@helpdesk.com");      // Finance
                var emp4 = await context.Users.FirstAsync(u => u.Email == "carol@helpdesk.com");    // Operations
            ...
            // Update DepartmentId for existing tickets that don't have one yet
            ...
            // Ensure designed-unassigned tickets are actually unassigned (fixes old round-robin data)
            ...
            // Ensure IT department has resolved tickets so manager stats are non-zero
