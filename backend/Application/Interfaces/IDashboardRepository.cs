...
namespace backend.Application.Interfaces
{
    ...
    {
        // ── Admin ────────────────────────────────────────────────────────────
        Task<int> CountTicketsByStatusNameAsync(string statusName);
        ...
        Task<int> CountAllTicketsAsync();
        Task<int> CountEscalatedTicketsAsync();
        Task<List<TicketTrendDto>> GetTicketTrendAsync(DateTime from);
        Task<List<CategoryBreakdownDto>> GetCategoryBreakdownAsync(int? deptId = null);
        Task<List<PriorityBreakdownDto>> GetPriorityBreakdownAsync(int? deptId = null);
        ...
        Task<int> CountDeptTicketsByStatusNamesAsync(int deptId, IEnumerable<string> statusNames);
        ...
        Task<List<(DateTime CreatedAt, DateTime UpdatedAt)>> GetResolvedTicketTimesAsync(int deptId);
        ...
        // ── Employee ──────────────────────────────────────────────────────────
        Task<int> CountEmployeeTicketsByStatusNameAsync(int employeeId, string statusName);
